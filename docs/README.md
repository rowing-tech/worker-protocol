...
| File | What it holds |
|---|---|
| [architecture.md](architecture.md) | The model and why it is shaped this way — Workers, the Hub, Tasks and Claims, Services and Contracts — opening with the dictionary of terms the rest of the repository uses |
